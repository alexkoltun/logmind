...
class LogStash::Inputs::GenericDb < LogStash::Inputs::Base
  ...
  config :jdbc_adapter, :validate => :string, :default => "com.mysql.jdbc.Driver"	
  config :jdbc_connection, :validate => :string, :default => "jdbc:mysql://localhost:3306/"
